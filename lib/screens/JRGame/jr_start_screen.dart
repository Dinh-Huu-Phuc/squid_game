  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Trò chơi con mực – Nhảy dây'),
        backgroundColor: Colors.transparent,
        elevation: 0,
      ),
      extendBodyBehindAppBar: true, // để background phủ lên dưới AppBar
      body: Stack(
        children: [
          // Background
          Positioned.fill(
          ...
          Center(
            child: SingleChildScrollView(
              padding: const EdgeInsets.symmetric(horizontal: 24).copyWith(top: kToolbarHeight + 24),
              child: Column(
